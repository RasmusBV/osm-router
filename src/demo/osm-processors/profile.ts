...
export const profile = {
    ...
    service_access_tag_blacklist: new Set<string | undefined>(['private']),
    ...
    excludable: [
        new Set<string | undefined>(['toll']),
        new Set<string | undefined>(['motorway']),
        new Set<string | undefined>(['ferry'])
    ],
